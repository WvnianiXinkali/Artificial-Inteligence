...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        super().__init__()
        self.hidden_layer1 = Linear(1, 256)
        self.hidden_layer2 = Linear(256, 256)
        self.hidden_layer3 = Linear(256, 128)
    ...
    def train(self, dataset):
        ...
        optimizer = optim.Adam(self.parameters(), lr=0.01005)
        epochs = 500
        keep_count = 50
        cur_count = 0
        loss_th = 0.02
        ...
        for epoch in range(epochs):
            ...
            if total_loss / len(dataloader) <= loss_th:
                cur_count += 1
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        output_size = 10
        "*** YOUR CODE HERE ***"
        self.hidden_layer1 = Linear(input_size, 256)
        self.hidden_layer2 = Linear(256, 128)
        self.hidden_layer3 = Linear(128, 64)
    ...
    def train(self, dataset):
        ...
        for epoch in range(num_epochs):
            ...
            if dataset.get_validation_accuracy() >= guess_th:
                break
...
class LanguageIDModel(Module):
    ...
    def __init__(self):
        ...
        self.hidden_layer1 = Linear(self.num_chars, self.hidden_size)
        self.hidden_layer2 = Linear(self.hidden_size, self.hidden_size)
    ...
    def run(self, xs):
        ...
        """
        "*** YOUR CODE HERE ***"
        hidden_state = torch.zeros(xs[0].shape[0], self.hidden_size).to(xs[0].device)
        for x in xs:
            hidden_state = relu(self.hidden_layer1(x) + self.hidden_layer2(hidden_state))
...
class Attention(Module):
    ...
    def forward(self, input):
        ...
        Attention = matmul(K, Q.movedim(1, 2))
        Attention = Attention / self.layer_size ** 0.5
