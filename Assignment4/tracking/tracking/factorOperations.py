...
def joinFactors(factors: List[Factor]):
    ...
    conditioned_vars = list(set(conditioned_vars) - set(unconditioned_vars))
    variable_domains = list(factors)[0].variableDomainsDict()
    ...
    for assignment in all_assignments:
        joint_prob = 1.0
        for factor in factors:
            joint_prob *= factor.getProbability(assignment)
        new_factor.setProbability(assignment, joint_prob)
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for assignment in all_assignments:
            ...
            for value in factor.variableDomainsDict()[eliminationVariable]:
                ...
                assign_copy[eliminationVariable] = value
                joint_prob += factor.getProbability(assign_copy)
            new_factor.setProbability(assignment, joint_prob)
